...
if LIVE:
    ...
    dest_dir = "/net/data/dns-ttl/dns_ttl_new/bind/"
    dest_dir_apache = "/net/data/dns-ttl/dns_ttl_new/apache/"
...
def bind_transfer():
    ...
    files_to_transfer = []
    for file in files_before_log_rotate:
        if not file.endswith("my_log.log"):
...
scheduler.add_job(apache_transfer, 'interval', minutes=300)
scheduler.start()